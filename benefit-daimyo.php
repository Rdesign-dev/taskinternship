  ...
  <main class="my-0 mx-auto min-h-full max-w-[480px] border border-slate-300">
    ...
    <div class="bg-white shadow-md mt-4">
      <div id="tabs" class="flex justify-center space-x-4 border-b border-gray-200">
        ...
        <a href="benefit-daimyo.php" class="text-gray-500 text-orange-500 font-bold px-4 py-2">Daimyo</a>
        <a href="benefit-shogun.php" class="text-gray-500 px-4 py-2">Shogun</a>
      </div>
      ...
      <div id="tab-content" class="p-4">
        ...
        <div class="tab-panel samurai">
          <ul class="list-disc ml-6 text-gray-700">
            <li>Gratis upgrade menu setiap pembelian paket spesial di Teras Japan</li>
            <li>Kumpulkan poin reward dan tukarkan dengan merchandise eksklusif</li>
            <li>Dapatkan akses awal ke menu baru sebelum resmi diluncurkan</li>
            <li>Promo buy 1 get 1 free setiap akhir bulan untuk member setia</li>
            <li>Gratis ongkos kirim untuk pemesanan online melalui aplikasi Teras Japan</li>
            <li>Undangan khusus untuk event member gathering dengan chef Teras Japan</li>
          </ul>
        </div>
